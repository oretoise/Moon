...
**IP Range:** Note: I have my NatNetwork set with a DHCP server with an IP address range of 10.0.2.0/24.
{: .notice}

## VM Discovery
We'll need to get the IP address of the target before we can interact with it. I use netdiscover, but Nmap works
